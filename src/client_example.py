...
from event import EventRegistration, TimerEventRegistration
...
class Client(FIXEngine):
    def __init__(self):
        FIXEngine.__init__(self, "bitwyre_order_logs.store")
        self.clOrdID = 0
    ...
    def onLogin(self, connectionHandler, msg):
        ...
        # lets do something like send an order
        price, quantity, side = self.askInput()
        self.sendOrder(connectionHandler, price, quantity, side)
